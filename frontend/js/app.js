...
function topNav(activeLabel) {
  const items = [
    { label: "Home", icon: `<svg viewBox="0 0 24 24" fill="none"><path d="m4 10 8-6 8 6v9a1 1 0 0 1-1 1h-4v-6H9v6H5a1 1 0 0 1-1-1v-9Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/></svg>` },
    { label: "About", icon: `<svg viewBox="0 0 24 24" fill="none"><path d="M6 3.5h9l3 3V20.5H6z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M14 3.5v4h4M9 12h6M9 16h6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>` },
    { label: "Methodology", icon: `<svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.8"/><path d="M12 3v2M12 19v2M3 12h2M19 12h2M5.6 5.6 7 7M17 17l1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>` },
    { label: "Contact", icon: `<svg viewBox="0 0 24 24" fill="none"><rect x="3.5" y="5.5" width="17" height="13" rx="2.2" stroke="currentColor" stroke-width="1.8"/><path d="m4.5 7 7 5.5L18.5 7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>` },
    { label: "Results", icon: `<svg viewBox="0 0 24 24" fill="none"><path d="M5 19V9m7 10V5m7 14v-7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>` },
  ];
  ...
  return `
    <aside class="topnav">
      ...
      <nav class="nav-links" aria-label="Main navigation">
        ${items.map((item) => `
          <button type="button" class="nav-link ${activeLabel === item.label ? "active" : ""}" data-nav="${item.label}">
      ...
      <div class="sidebar-bottom">
        <div class="sidebar-message">
          <span class="sidebar-message-kicker">SMARTER BENCHMARKS.</span>
          <strong>Better insights.<br>Stronger decisions.</strong>
          <span>Compare · Improve · Grow.</span>
        </div>
...
function renderHome() {
    ...
    <main class="home-main">
      <section class="home-hero">
        <div class="home-hero-copy">
          <div class="home-kicker"><span class="kicker-icon">↗</span> DATA DRIVEN <i></i> SMARTER DECISIONS</div>
          <h1>Benchmark your mill against <span>industry performance</span></h1>
          <p>Compare your key performance indicators with paper-industry benchmarks, understand your percentile position, and identify opportunities to improve efficiency and profitability.</p>
          <div class="home-actions">
            <button class="btn home-primary" id="btn-home-continue">Get Started <span>→</span></button>
            <button class="home-text-link" data-nav="Methodology">How it works <span>→</span></button>
          </div>
          <div class="home-mini-stats">
            <div><strong>26+</strong><span>Industry KPIs</span></div>
            <div><strong>6</strong><span>Performance areas</span></div>
            <div><strong>0–100</strong><span>Benchmark scale</span></div>
          </div>
        </div>
        <div class="home-hero-art">
          <div class="art-orbit orbit-one"></div>
          <div class="art-orbit orbit-two"></div>
          <div class="hero-image-frame"><img src="img/paper-mill-hero.png" alt="Paper mill industry"></div>
          <div class="floating-metric"><span class="metric-icon">↗</span><div><small>Benchmark position</small><strong>+12% ↑</strong></div></div>
          <div class="floating-note">Smarter benchmarking<br>for a stronger tomorrow <span>↙</span></div>
        </div>
      </section>

      <section class="platform-section">
        <div class="section-heading-row">
          <div><span class="section-line"></span><span class="section-kicker">EXPLORE THE PLATFORM</span><h2>Everything you need to understand performance</h2></div>
          <span class="section-count">01 — 03</span>
        </div>

        <div class="home-feature-grid">
          <article class="home-feature-card card-blue" data-nav="About" tabindex="0" role="button">
            <div class="feature-top"><span class="big-feature-icon">▥</span><span class="feature-number">01</span></div>
            <h3>Industry Benchmarks</h3><p>Understand where your mill stands against benchmark performance.</p>
            <span class="feature-link">Explore benchmarks <b>→</b></span>
            <div class="feature-visual bars"><i></i><i></i><i></i><i></i></div>
          </article>
          <article class="home-feature-card card-sky" data-nav="Methodology" tabindex="0" role="button">
            <div class="feature-top"><span class="big-feature-icon">⌁</span><span class="feature-number">02</span></div>
            <h3>KPI Percentiles</h3><p>See how each KPI maps onto your benchmark distribution.</p>
            <span class="feature-link">View methodology <b>→</b></span>
            <div class="feature-visual line-chart"><svg viewBox="0 0 180 70" fill="none"><path d="M4 58 C28 55 33 35 55 42 S83 62 105 34 S132 18 176 9" stroke="currentColor" stroke-width="3" stroke-linecap="round"/><circle cx="132" cy="18" r="5" fill="currentColor"/></svg></div>
          </article>
          <article class="home-feature-card card-lilac" data-nav="Results" tabindex="0" role="button">
            <div class="feature-top"><span class="big-feature-icon">◎</span><span class="feature-number">03</span></div>
            <h3>Actionable Insights</h3><p>Find strengths and improvement areas from your results dashboard.</p>
            <span class="feature-link">Go to results <b>→</b></span>
            <div class="feature-visual target-mark">◎</div>
          </article>
        </div>
      </section>
    </main>
  ...
  document.querySelectorAll(".home-feature-card[data-nav]").forEach((el) => {
    const open = () => {
      const destination = el.getAttribute("data-nav");
      state.page = destination === "About" ? "about" : destination === "Methodology" ? "methodology" : "results";
      render();
    };
...
<p class="lede">
  Provide your current KPI values. You can expand each category to enter the relevant metrics.
</p>

<p class="kpi-note">
  <strong>Note:</strong> Filling all KPIs is not mandatory. You can enter the values that are relevant to your mill.
</p>
...
<div class="progress-meta"><span>${filled} of ${allKpis.length} KPIs completed</span><span>${Math.round((filled / allKpis.length) * 100)}%</span></div>
      ...
      <div class="row-actions">
        <button class="btn btn-ghost" id="btn-back">&#8592; Back</button>
        <button type="button" class="btn" id="btn-calc" ${filled === 0 ? "disabled" : ""}>
  Calculate Results &#8594;
</button>
      </div>
    </div>
